export class Cuboid implements ICuboid {
    ...
    intersects(cuboid: ICuboid): boolean {
        return (this.x0 >= cuboid.x0 && this.x0 <= cuboid.x1 || this.x1 >= cuboid.x0 && this.x1 <= cuboid.x1)
            && (this.y0 >= cuboid.y0 && this.y0 <= cuboid.y1 || this.y1 >= cuboid.y0 && this.y1 <= cuboid.y1)
            && (this.z0 >= cuboid.z0 && this.z0 <= cuboid.z1 || this.z1 >= cuboid.z0 && this.z1 <= cuboid.z1);
    }
